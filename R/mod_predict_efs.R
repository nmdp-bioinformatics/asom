...
mod_predict_efs_ui <- function(id){
    ns <- NS(id)
    tagList(
...
#' predict_efs Server Functions
#' @import shiny
#' @import ggplot2
#' @noRd
mod_predict_efs_server <- function(id, xtest, pyear){
    moduleServer( id, function(input, output, session){
        ...
        observe({
            ...
            p <- ggplot(data = ptbl
                ...
                ylab(paste0(pyear, "-Year Event-Free Survival\n")) +
                xlab("\nDonor Age") +
...
# mod_mod_predict_efs_ui("mod_predict_efs_1")

## To be copied in the server
# mod_mod_predict_efs_server("mod_predict_efs_1")
